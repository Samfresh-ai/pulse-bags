...
function GoogleIcon() {
  return <Image src="/Icons/google-icon.svg" alt="Google Icon" width={16} height={16}/>;
}

function XIcon() {
  return <Image src="/Icons/x-icon.svg" alt="X Icon" width={16} height={16}/>;
}
...
function WalletIcon() {
  return <Image src="/Icons/wallet-icon.svg" alt="Wallet Icon" width={16} height={16}/>;
}
